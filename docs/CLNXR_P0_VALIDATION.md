...
| Pacote portátil local | Gerado e conferido | ZIP contém 16 entradas somente sob `CLNXR-Portable/`: executável gráfico, `CLNXR.Cli.exe`, DLLs `Clnxr.*`, catálogo declarativo em `rules/`, changelog, avisos de terceiros, versão, privacidade, SBOM e manifestos de hash. SHA-256 do ZIP: `CF62E7230ED5EA8131A0C749DA24F9EA159CDC4157D6E1515F12F69467A4F2BC`; o CLI do bundle concluiu dry-run JSON redigido e o smoke desktop carregou o executável sem exibi-lo. |
