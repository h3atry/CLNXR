...
| Ferramentas P2 somente leitura | enumera locais de inicialização sem escrever no Registro/pastas e consulta um arquivo real pelo Restart Manager sem alterar o arquivo. | Não substitui teste visual, ACL, VM limpa ou locks de aplicativos de terceiros. |
